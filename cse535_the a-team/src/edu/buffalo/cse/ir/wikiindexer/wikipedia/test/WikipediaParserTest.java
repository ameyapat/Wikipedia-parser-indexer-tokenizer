...
public class WikipediaParserTest {
	...
	public final void testParseTagFormatting() {
		...
		assertEquals("This iconic chair, in production,[http:k, 83, designer of famous office chair, August 22, 2013]", WikipediaParser.parseTagFormatting("This iconic chair, in production,&lt;ref&gt;[http:k, 83, designer of famous office chair, August 22, 2013]&lt;/ref&gt;"));
	...
	public final void testParseTemplates() {
		...
		assertEquals("abc  xyz", WikipediaParser.parseTemplates("abc {{Persondata |NAME = Kay, Kathie" +
	...
	public final void testParseLinks() {
		...
		assertEquals(new Object[]{"abc Wikipedia logo xyz",""}, WikipediaParser.parseLinks("abc [[File:wiki.png|frame|alt=Puzzle globe|Wikipedia logo]] xyz"));
