...
public class SingleRunner {
	...
	*/
	...
	try {
		IndexReader r=new IndexReader(properties,INDEXFIELD.TERM);
		int k=r.getTotalKeyTerms();
		System.out.println("total terms: "+k);
		k=r.getTotalValueTerms();
		System.out.println("total size of docDict: "+k);
		Collection<String>c=r.getTopK(50);
