...
public class TokenizerFactory {
	...
	public Tokenizer getTokenizer(INDEXFIELD field) throws TokenizerException {
		...
		return new Tokenizer(new AccentRule(), new DateRule(), new PunctuationRule(), new WhitespaceRule(), new CapitalizationRule(), new ApostropheRule(), new HyphenRule(), new SpecialCharsRule(), new StopWordsRule(), new NumberRule());
		else if(field==INDEXFIELD.AUTHOR)
		return new Tokenizer(new HyphenRule(), new SpecialCharsRule());
		else if(field==INDEXFIELD.CATEGORY)
		return new Tokenizer(new WhitespaceRule(), new HyphenRule(), new StopWordsRule(), new NumberRule());
		return null;
