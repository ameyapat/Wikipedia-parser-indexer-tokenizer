...
public class MyDateRuleTest {
	...
	public void test() throws TokenizerException {
		...
		assertArrayEquals(
				new Object[] { "19000402 is the 101st day of the year (102nd in leap years) in the Gregorian calendar." },
				runtest("April 2 is the 101st day of the year (102nd in leap years) in the Gregorian calendar."));
		assertArrayEquals(
